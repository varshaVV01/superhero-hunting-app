...
async function loadChars(query){
    const URL = `http://gateway.marvel.com/v1/public/characters?nameStartsWith=${query}&ts=1&apikey=f6c49950a245b5c78806e7ba5c9eb5b7&hash=3568084a8d6d439bbead379d13f5b8c1`
...
function displayCharList(chars){
    ...
    for(let idx = 0 ; idx < chars.length ; idx++){
        ...
        redirectLink.href = "details/details.html?character=" + chars[idx].id;
        ...
        <div class="search-item-info"> 
            <a href = ${ "details/details.html?character=" + chars[idx].id }> <h3>${chars[idx].name}</h3> </a>
...
function loadCharDetails(){
    ...
    searchConstList.forEach(character =>{
        ...
        character.addEventListener('click' ,async()=>{
            ...
            charSearchBox.value = "";
            const result = await fetch(`https://gateway.marvel.com:443/v1/public/characters/${character.dataset.id}?ts=1&apikey=f6c49950a245b5c78806e7ba5c9eb5b7&hash=3568084a8d6d439bbead379d13f5b8c1`)
...
async function homeLoadHeros(query){
    const URL = 'https://gateway.marvel.com:443/v1/public/characters?ts=1&apikey=f6c49950a245b5c78806e7ba5c9eb5b7&hash=3568084a8d6d439bbead379d13f5b8c1';
    const response = await fetch(`${URL}`);
    const data = await response.json();
  //  console.log(data.data.results);
